...
public class function {
    ...
    public static void main(String[] args) {
        ...
        // compose means : first tripeIt, then doubleIt
        System.out.println(doubleIt.compose(tripleIt).apply(30));

        // identity(): returns the same value that is passed in as input
        ...
        UnaryOperator<Integer> v = (e) -> 2 * e;   // If a Function<T, R> has the same generic type for both T and R (Function<T, T>), you can replace it with UnaryOperator<T>.
